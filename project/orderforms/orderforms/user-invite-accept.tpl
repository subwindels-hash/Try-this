...
<div class="inner-content-area container">
<div class="row">
                        ...
                        <div class="invite-box">
                            ...
                            <form method="post" action="{routePath('login-validate')}" class="text-left">
                                <div class="form-group">
                                    <label for="inputLoginEmail" class="control-label">{lang key="loginemail"}</label>
                                ...
                                <div class="form-group">
                                    <label for="inputLoginPassword" class="control-label">{lang key="loginpassword"}</label>
                    ...
                    <div class="col-sm-6">
                        <div class="invite-box">
                            ...
                            <form method="post" action="{routePath('invite-validate', $invite->token)}" class="text-left">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail" class="control-label">{lang key="loginemail"}</label>
                                    <input type="email" name="email" class="form-control" id="inputEmail" placeholder='{lang key="loginemail"}' value="{$formdata.email}">
                                </div>
                                <div class="form-group has-feedback">
                                    <label for="inputPassword" class="control-label">{lang key="loginpassword"}</label>
