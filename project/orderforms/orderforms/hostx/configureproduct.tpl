...
var _localLang = {
	...
	{if $productinfo.module eq 'soyoustart' || $productinfo.module eq 'soyoustart_vps'}	
		<link rel="stylesheet" href="{$WEB_ROOT}/templates/orderforms/{$carttpl}/css/style-design.css">
		<link rel="stylesheet" href="{$WEB_ROOT}/templates/orderforms/{$carttpl}/css/font-awesome.css" type="text/css">
    	<link rel="stylesheet" href="{$WEB_ROOT}/templates/orderforms/{$carttpl}/css/all.min.css">
    	<link rel="stylesheet" href="{$WEB_ROOT}/templates/orderforms/{$carttpl}/css/style-ovh.css" type="text/css">
    	<link rel="stylesheet" href="{$WEB_ROOT}/templates/orderforms/{$carttpl}/css/responsive.css" type="text/css">
          		...
          		<div class="col-md-3">
  					<div class="billingcycle-box">
  						<div class="custom-radios">
					        ...
					        <input type="radio" class="radio-custom" name="billingcycle" id="cycle1" value="monthly"{if $billingcycle eq "monthly"} checked{/if}  onchange ="updatesoyoustartbilling();" onclick="updateConfigurableOptions({$i}, this.value); return false" />
  			...
  			{/if}
          		...
          		<div class="col-md-3">
  					<div class="billingcycle-box">
  						<div class="custom-radios">
					        <!--<input id="radio-1" class="radio-custom" name="radio-group" type="radio">-->
					         <input type="radio" name="billingcycle" class="radio-custom" id="cycle2" value="quarterly"{if $billingcycle eq "quarterly"} checked{/if}  onchange ="updatesoyoustartbilling();" onclick="updateConfigurableOptions({$i}, this.value); return false" />
  			...
  			{/if}
          		...
          		<div class="col-md-3">
  					<div class="billingcycle-box">
  						<div class="custom-radios">
					        <!--<input id="radio-1" class="radio-custom" name="radio-group" type="radio">-->
					           <input type="radio" name="billingcycle" class="radio-custom" id="cycle3" value="semiannually"{if $billingcycle eq "semiannually"} checked{/if}  onchange ="updatesoyoustartbilling();" onclick="updateConfigurableOptions({$i}, this.value); return false" />
  			...
  			{/if}
          		...
          		<div class="col-md-3">
  					<div class="billingcycle-box">
  						<div class="custom-radios">
					        <!--<input id="radio-1" class="radio-custom" name="radio-group" type="radio">-->
					           <input type="radio" name="billingcycle" class="radio-custom" id="cycle4" value="annually"{if $billingcycle eq "annually"} checked{/if} onchange ="updatesoyoustartbilling();"  onclick="updateConfigurableOptions({$i}, this.value); return false" />
  			...
  			{if $pricing.biennially}
          		<div class="col-md-3">
  					<div class="billingcycle-box">
  						<div class="custom-radios">
					        <!--<input id="radio-1" class="radio-custom" name="radio-group" type="radio">-->
					       <input type="radio" name="billingcycle" id="cycle5" class="radio-custom" value="biennially"{if $billingcycle eq "biennially"} checked{/if}  onchange ="updatesoyoustartbilling();" onclick="updateConfigurableOptions({$i}, this.value); return false" />
  		    ...
  		    {if $pricing.triennially}
          		<div class="col-md-3">
  					<div class="billingcycle-box">
  						<div class="custom-radios">
					        <!--<input id="radio-1" class="radio-custom" name="radio-group" type="radio">-->
					       <input type="radio" name="billingcycle" id="cycle6" class="radio-custom" value="triennially"{if $billingcycle eq "triennially"} checked{/if} onchange ="updatesoyoustartbilling();"  onclick="updateConfigurableOptions({$i}, this.value); return false" />
