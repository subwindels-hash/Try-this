    ...
    <form class="form-horizontal" role="form" method="post" action="{$smarty.server.PHP_SELF}?action=contacts">
        <div class="row">
            <div class="form-group">
                <label class="control-label">{$LANG.clientareachoosecontact}</label>
        ...
        <div id="subacct-container" class="well{if !$subaccount} hidden{/if}">
            ...
            <div class="row cntcpsw">
                <div class="form-group">
                    ...
                    <div class="col-sm-3 no-padding-use">
                ...
                <div class="form-group">
                    ...
                    <span id="inputNewPassword2Msg"></span>
                </div>
                <div class="form-group pwstrengthcm">
