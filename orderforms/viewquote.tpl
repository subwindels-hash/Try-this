...
<body>
    ...
    <div class="viewquote container-fluid invoice-container">
        ...
        {else}
            ...
            <div class="pull-right btn-group btn-group-sm hidden-print">
                <a href="javascript:window.print()" class="btn-print-inv btn-style"><i class="fas fa-print"></i> {$LANG.print}</a>
                <a href="dl.php?type=q&amp;id={$quoteid}" class="btn-download-inv btn-style"><i class="fas fa-download"></i> {$LANG.invoicesdownload}</a>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-print-inv btn-style" data-dismiss="modal">{$LANG.cancel}</button>
                        <button type="submit" class="btn-download-inv btn-style">{$LANG.quoteacceptbtn}</button>
                    </div>
                </div>
            </div>
        </div>
